			...
			<div id="form-block">
				<form id="myForm" action="" method="post">
					<div id="congress-selection">
						...
						<select id="con-select" style="" name="Select your option" onchange="selectChange()">
					...
					<div id="keyword-selection">
						...
						<input type="text" id="keyword-input" value="<?php if(isset($_POST['keyword'])) { echo htmlentities ($_POST['keyword']); }?>" name="keyword" style="width: 130px;"><br>
					</div>
